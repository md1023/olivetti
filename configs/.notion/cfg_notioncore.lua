...
--  kpress(META.."Shift+comma", "ioncore.goto_prev_screen()"),
    ...
    -- kpress(META.."W", "ioncore.goto_next(_chld, 'down')", 
    --        "_chld:non-nil"),
    -- kpress(META.."Shift+W", "ioncore.goto_next(_chld, 'up')", 
    --        "_chld:non-nil"),
        
    -- bdoc("Raise focused object, if possible."),
    kpress(META.."Shift+R", "WRegion.rqorder(_chld, 'front')",
    	   "_chld:non-nil")
})
...
defbindings("WMPlex.toplevel", {
    ...
    kpress(META.."Control+F2", "ioncore.exec_on(_, FILEMANAGER)"),
