...
mod_statusbar.create{
    ...
    template="%filler%systray"..
       " [ %date | load: %load | net: %netmon_kbsin/%netmon_kbsout ]"..
       " CPU [ programs: %info_CPU_user | system: %info_CPU_system ]"..
       " RAM [ total: %info_RAM_total | free: %info_RAM_free ]"..
       " Volume [ %volume_level %volume_state] %filler%systray",

    --template="%filler%systray [ %date | load: %load | net: %netmon_kbsin/%netmon_kbsout ] CPU [ programs: %info_CPU_user | system: %info_CPU_system ] RAM [ total: %info_RAM_total | free: %info_RAM_free ] SWAP [ total: %info_swap_total | free: %info_swap_free ] %filler%systray",
    --template="%date | load: %load | net: %netmon_kbsin/%netmon_kbsout CPU [programs: %info_CPU_user | system: %info_CPU_system] RAM [total: %info_RAM_total | used: %info_RAM_used | free: %info_RAM_free ] SWAP [ total:  %info_swap_total | used: %info_swap_used | free: %info_swap_free ] %filler%systray ",
