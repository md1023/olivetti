...
;;;;; font lock
   ...
   `(font-lock-comment-face ((t (:foreground "#67a5cb"))))
   `(font-lock-comment-delimiter-face ((t (:foreground "#67a5cb"))))
   ...
   `(font-lock-type-face ((t (:foreground "#C1DEA4"))))
...
;;;;; jabber-mode
   `(jabber-roster-user-xa ((t (:foreground ,zenburn-bg+2))))
   `(jabber-roster-user-away ((t (:foreground ,zenburn-bg+3))))
   `(jabber-roster-user-online ((t (:foreground ,zenburn-yellow-2))))
   `(jabber-roster-user-chatty ((t (:foreground ,zenburn-yellow-1))))
   `(jabber-roster-user-dnd ((t (:foreground ,zenburn-red-1))))
   `(jabber-rare-time-face ((t (:foreground ,zenburn-green))))
   `(jabber-chat-prompt-local ((t (:foreground ,zenburn-blue-1))))
   `(jabber-chat-prompt-foreign ((t (:foreground ,zenburn-blue-3))))
...
;;   `(linum ((t (:foreground ,zenburn-green+2 :background ,zenburn-bg))))
   `(linum ((t (:foreground "#888888" :background ,zenburn-bg))))
;;;;; macrostep
   `(macrostep-gensym-1
...
;;;;; org-mode zenburn
   ...
   `(org-level-1 ((t (:bold t :foreground ,zenburn-blue+1 :height: 1.2))))
   `(org-level-2 ((t (:foreground ,zenburn-blue+1))))
   `(org-level-3 ((t (:foreground ,zenburn-blue))))
   `(org-level-4 ((t (:foreground ,zenburn-blue-1))))
   `(org-level-5 ((t (:foreground ,zenburn-blue-2))))
   `(org-level-6 ((t (:foreground ,zenburn-blue-3))))
   `(org-level-7 ((t (:foreground ,zenburn-blue-4))))
   `(org-level-8 ((t (:foreground ,zenburn-blue-5))))
